...
/* ─────────────────────────────────────────────
   ENHANCED CREW SECTION (PROOF OF WORK)
   ───────────────────────────────────────────── */
const ProofOfWork = ({
  title = 'The Crew',
  works,
  ...
  return (
    <div ref={containerRef} className={cn('w-full bg-[#0B0B0F] px-6 py-28 text-white md:px-12', className)}>
      <div className="mx-auto max-w-[1300px]">
        <div className="text-center mb-20">
          <p className="text-[0.65rem] tracking-[0.35em] uppercase text-[#C8A96E] mb-6">
            Meet the Team
          </p>
          <h1 className="font-serif text-[clamp(2.5rem,5vw,4rem)] font-normal text-[#E8E4DC] leading-[1.15] mb-6">
            The <em className="italic text-[#C8A96E]">Crew</em>
          </h1>
          <div className="w-12 h-px bg-[#C8A96E] mx-auto mb-6" />
          <p className="text-[0.85rem] font-light text-[#E8E4DC]/40 max-w-md mx-auto leading-[1.8]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-5">
          {works.map((work, index) => (
            <div
              ...
              style={{
                borderRadius: '1rem',
                aspectRatio: index % 5 === 0 ? '1/1' : index % 7 === 3 ? '2/1' : '3/4',
              }}
            ...
            >
              <img
                ...
                style={{
                  filter: hoveredIndex !== null && hoveredIndex !== index ? 'brightness(0.4) grayscale(0.6)' : 'brightness(0.85) grayscale(0.3)',
              ...
              <div 
                ...
                style={{
                  background: 'linear-gradient(to top, rgba(11,11,15,0.95) 0%, rgba(11,11,15,0.5) 40%, transparent 70%)',
                }}
              />
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-5 md:p-6">
                <span 
                  className="inline-block self-start px-2.5 py-1 mb-3 text-[0.55rem] font-medium tracking-[0.2em] text-[#C8A96E] uppercase bg-[#C8A96E]/10 backdrop-blur-sm rounded-full border border-[#C8A96E]/20 transition-all duration-500"
                  style={{
                ...
                <h3 
                  className="font-serif text-xl md:text-2xl font-normal text-[#E8E4DC] tracking-tight leading-tight transition-all duration-500"
                  style={{
                ...
                >
                  <p className="text-[0.7rem] text-[#E8E4DC]/50 mt-2 leading-relaxed">
                    {work.description || 'Crafting exceptional digital experiences with precision and passion.'}
                  </p>
                </div>

                <div 
                  className="flex gap-3 mt-3 transition-all duration-500"
                  style={{
                    opacity: hoveredIndex === index ? 1 : 0,
                ...
                >
                  {['Twitter', 'LinkedIn', 'Dribbble'].map((social) => (
                    <a
                      key={social}
                      href="#"
                      className="text-[0.55rem] tracking-[0.1em] uppercase text-[#E8E4DC]/40 hover:text-[#C8A96E] transition-colors"
              ...
              <div 
                className="absolute top-4 right-4 w-6 h-6 border-t border-r border-[#C8A96E]/0 group-hover:border-[#C8A96E]/60 transition-all duration-500"
              />
              <div 
                className="absolute top-4 right-4 w-6 h-6 border-t border-r border-[#C8A96E]/0 group-hover:border-[#C8A96E]/60 transition-all duration-500 delay-100"
        ...
        <div className="text-center mt-20">
          ...
          <a 
            href="#contact" 
            className="inline-flex items-center gap-2 text-[0.72rem] tracking-[0.12em] uppercase px-8 py-3.5 border border-[#C8A96E]/40 text-[#C8A96E] hover:bg-[#C8A96E] hover:text-[#0B0B0F] transition-all duration-300 rounded-full"
          >
...
const crewMembers = [
  { 
    ...
    description: '15 years shaping brands for Fortune 500 companies. Believes design is strategy made visible.'
  },
  { 
    image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=600&q=80', 
    imageAlt: 'Elena Vasquez - Lead Designer', 
    title: 'Elena Vasquez', 
    subtitle: 'Lead Designer',
    description: 'Award-winning UI/UX specialist. Obsessed with micro-interactions and pixel perfection.'
  },
  { 
    image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=600&q=80', 
    imageAlt: 'James Whitfield - Tech Lead', 
    title: 'James Whitfield', 
    subtitle: 'Tech Lead',
    description: 'Full-stack developer with a passion for performance and clean, scalable code.'
  },
  { 
    image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=600&q=80', 
    imageAlt: 'Sophia Nakamura - Brand Strategist', 
    title: 'Sophia Nakamura', 
    subtitle: 'Brand Strategist',
    description: 'Former brand consultant at Pentagram. Turns business goals into compelling narratives.'
  },
  { 
    image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=600&q=80', 
    imageAlt: 'David Okonkwo - Motion Designer', 
    title: 'David Okonkwo', 
    subtitle: 'Motion Designer',
    description: 'Bringing interfaces to life with purposeful animation and cinematic transitions.'
  },
  { 
    image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&q=80', 
    imageAlt: 'Aria Lindqvist - UX Researcher', 
    title: 'Aria Lindqvist', 
    subtitle: 'UX Researcher',
    description: 'Human-centered design advocate. Turns user insights into product decisions.'
  },
  { 
    image: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=600&q=80', 
    imageAlt: 'Kai Tanaka - Frontend Engineer', 
    title: 'Kai Tanaka', 
    subtitle: 'Frontend Engineer',
    description: 'React wizard and WebGL enthusiast. Pushing the boundaries of browser experiences.'
  },
  { 
    image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=600&q=80', 
    imageAlt: 'Maya Patel - Project Manager', 
    title: 'Maya Patel', 
    subtitle: 'Project Manager',
    description: 'Orchestrating complex projects with calm precision. The glue that holds it all together.'
  },
  { 
    image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=600&q=80', 
    imageAlt: 'Lucas Bergström - 3D Artist', 
    title: 'Lucas Bergström', 
    subtitle: '3D Artist',
    description: 'Creating immersive 3D experiences and WebGL environments that captivate and convert.'
  },
  { 
    image: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=600&q=80', 
    imageAlt: 'Zara Hassan - Content Strategist', 
    title: 'Zara Hassan', 
    subtitle: 'Content Strategist',
    description: 'Wordsmith and SEO expert. Crafting narratives that rank and resonate.'
  },
  { 
    image: 'https://images.unsplash.com/photo-1504257432389-52343af06ae3?w=600&q=80', 
    imageAlt: 'Noah Fischer - DevOps Engineer', 
    title: 'Noah Fischer', 
    subtitle: 'DevOps Engineer',
    description: 'Infrastructure engineer ensuring our work performs flawlessly at any scale.'
  },
  { 
    image: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=600&q=80', 
    imageAlt: 'Isla Romano - Art Director', 
    title: 'Isla Romano', 
    subtitle: 'Art Director',
    description: 'Visual storyteller with an eye for composition that elevates every project.'
  },
];
